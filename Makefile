...
#    Updated: 2024/12/11 10:46:11 by togauthi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): $(OBJS_DIR) $(LIBFT) $(COMMON_OBJS) $(MANDATORY_OBJS)
	@echo "$(YELLOW)Compiling project... $(WHITE)[$(GREEN)4$(WHITE)/$(AQUA)4$(WHITE)]"
	@cc $(CFLAGS) -o $(NAME) $(COMMON_OBJS) $(MANDATORY_OBJS) $(LIBFT)
	@echo "$(GREEN)Done.$(WHITE)"
	
$(OBJS_DIR):
	@echo "$(YELLOW)Creating destination... $(WHITE)[$(GREEN)1$(WHITE)/$(AQUA)4$(WHITE)]"
	@mkdir -p $(OBJS_DIR)
...
clean:
	...
	@echo "$(YELLOW)Cleaning objects... $(WHITE)[$(GREEN)2$(WHITE)/$(AQUA)2$(WHITE)]"
	@rm -rf objs
	@echo "$(GREEN)Done.$(WHITE)"
...
fclean: clean
	@echo "$(YELLOW)Cleaning libft... $(WHITE)[$(GREEN)1$(WHITE)/$(AQUA)2$(WHITE)]"
	@rm -f $(LIBFT)
	@echo "$(YELLOW)Cleaning result... $(WHITE)[$(GREEN)1$(WHITE)/$(AQUA)2$(WHITE)]"
	@rm -f $(NAME)
	@echo "$(GREEN)Done.$(WHITE)"
